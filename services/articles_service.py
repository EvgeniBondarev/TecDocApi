...
class ArticlesService:
    ...
    async def get_article_by_id(self, supplier_id: int, article: str) -> Optional[ArticlesSchema]:
    ...
    async def get_articles_by_found_string_and_supplier_id(self, supplier_id: int ,article: str)-> ArticlesSchema:
        filter_condition = (
                (self.repository.model.supplierId == supplier_id) &
                (self.repository.model.DataSupplierArticleNumber == article)
        )
